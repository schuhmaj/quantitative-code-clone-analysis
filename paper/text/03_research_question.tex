...
\refrq{question:clone_coverage_lowest} searches for the most promising programming language in terms of code clone coverage and flows into the generalization that contemporary programming languages are generally better than ancient languages.
