...
\refrq{question:clone_coverage_lowest} searches for the best programming language in terms of code clone coverage and flows into the generalization if modern programming languages are generally better than older languages.
